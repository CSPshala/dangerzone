...
{	
	...
	void ParticleShader::RenderShader(int indexCount)
{
	...
	ApplicationSettings::g_DeviceContext->GSSetShader(m_geometryShader, NULL, 0);
	ApplicationSettings::g_DeviceContext->PSSetShader(m_pixelShader, NULL, 0);

	// Render the triangle.
	ApplicationSettings::g_DeviceContext->Draw(1,0);
}
